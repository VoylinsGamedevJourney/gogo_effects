...
class GoGoEffectsEncoder : public Resource {
	GDCLASS(GoGoEffectsEncoder, Resource);
  ...
  private:
	...
	static inline void _log(String message) { UtilityFunctions::print("GoGoEffectsEncoder: ", message, "."); }
	static inline bool _log_err(String message) {
		UtilityFunctions::printerr("GoGoEffectsEncoder: ", message, "!");
		return false;
	}
